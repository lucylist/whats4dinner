  ...
  if (!currentPlan) {
    return (
      <div className="text-center py-16 space-y-6">
        ...
        <div>
          <h2 className="text-4xl sm:text-5xl font-cursive text-cream-100 mb-2">No Calendar Yet</h2>
    ...
    <div className="pt-4 sm:pt-6 space-y-4 sm:space-y-6">
      ...
      <div className="flex justify-between items-center gap-3">
        <div className="min-w-0">
          <h2 className="text-4xl sm:text-5xl font-cursive text-cream-100 truncate">
            This Week's Menu
          </h2>
